...
public class DirectMessageController {
    ...
    public ApiResponse<List<DirectMessageResponse>> getDirectMessages(
            ...
            HttpServletRequest request) {
        UUID currentUserId = UUID.fromString(request.getHeader("X-User-Id"));
        return ApiResponse.success(directMessageService.getDirectMessages(conversationId, currentUserId, page, size, before));
    }

    @GetMapping("/api/dm/conversations/{conversationId}/messages/search")
    public ApiResponse<List<DirectMessageResponse>> searchDirectMessages(
            @PathVariable("conversationId") Long conversationId,
        ...
        return ApiResponse.success(
                directMessageService.searchDirectMessages(conversationId, currentUserId, query, page, size)
        );
    }
