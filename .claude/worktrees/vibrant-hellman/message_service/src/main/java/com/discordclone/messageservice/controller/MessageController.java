...
public class MessageController {
    ...
    public ApiResponse<List<MessageResponse>> getMessages(
        ...
        return ApiResponse.success(messageService.getMessages(channelId, UUID.fromString(userId), page, size, before));
    }

    @GetMapping("/api/messages/channels/{channelId}/search")
    public ApiResponse<List<MessageResponse>> searchMessages(
        ...
        return ApiResponse.success(messageService.searchMessages(channelId, userId, query, page, size));
    }
