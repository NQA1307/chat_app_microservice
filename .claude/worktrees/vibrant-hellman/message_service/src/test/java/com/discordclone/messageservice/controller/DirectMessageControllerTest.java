...
class DirectMessageControllerTest {
    ...
    void getMessages_returnsPagedMessages() throws Exception {
        ...
        when(directMessageService.getDirectMessages(1L, USER_1, 0, 50, null)).thenReturn(messages);
    ...
    void getMessages_customPageAndSize() throws Exception {
        when(directMessageService.getDirectMessages(1L, USER_1, 2, 10, null)).thenReturn(List.of());
        ...
        verify(directMessageService).getDirectMessages(1L, USER_1, 2, 10, null);
    }
